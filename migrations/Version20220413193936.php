 ...
 */
final class Version20220413193936 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE doctor CHANGE is_active is_active TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE doctor CHANGE is_active is_active TINYINT(1) DEFAULT \'0\' NOT NULL');
    }
}
